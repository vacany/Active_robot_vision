...
def make_model(model_name, num_classes, voxel_size) -> nn.Module:
    ...
    if model_name == 'minkunet':
        from pat.spvnas_wrap.core.models.semantic_kitti import MinkUNet
        model = MinkUNet(num_classes=num_classes, cr=cr)

    elif model_name == 'spvcnn':
        from pat.spvnas_wrap.core.models.semantic_kitti import SPVCNN
...
if __name__ == '__main__':
    ...
    # You need config ...
    dataset = Sequence_Loader(dataset_name=DATASET_NAME, sequence=4)
